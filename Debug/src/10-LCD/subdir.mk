...
src/10-LCD/%.o: ../src/10-LCD/%.cpp src/10-LCD/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-10-2d-LCD

clean-src-2f-10-2d-LCD:
	-$(RM) ./src/10-LCD/Lcd.d ./src/10-LCD/Lcd.o

.PHONY: clean-src-2f-10-2d-LCD
