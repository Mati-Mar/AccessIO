...
CPP_SRCS += \
../src/04-EntradasDigitales/digital_inputs.cpp 

CPP_DEPS += \
./src/04-EntradasDigitales/digital_inputs.d 

OBJS += \
./src/04-EntradasDigitales/digital_inputs.o 


# Each subdirectory must supply rules for building sources it contributes
src/04-EntradasDigitales/%.o: ../src/04-EntradasDigitales/%.cpp src/04-EntradasDigitales/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-04-2d-EntradasDigitales

clean-src-2f-04-2d-EntradasDigitales:
	-$(RM) ./src/04-EntradasDigitales/digital_inputs.d ./src/04-EntradasDigitales/digital_inputs.o

.PHONY: clean-src-2f-04-2d-EntradasDigitales
