...
CPP_SRCS += \
../src/08-teclado/teclado.cpp 

CPP_DEPS += \
./src/08-teclado/teclado.d 

OBJS += \
./src/08-teclado/teclado.o 


# Each subdirectory must supply rules for building sources it contributes
src/08-teclado/%.o: ../src/08-teclado/%.cpp src/08-teclado/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-08-2d-teclado

clean-src-2f-08-2d-teclado:
	-$(RM) ./src/08-teclado/teclado.d ./src/08-teclado/teclado.o

.PHONY: clean-src-2f-08-2d-teclado
