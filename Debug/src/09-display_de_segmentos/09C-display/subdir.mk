...
CPP_SRCS += \
../src/09-display_de_segmentos/09C-display/digito.cpp \
../src/09-display_de_segmentos/09C-display/display7Segmentos.cpp \
../src/09-display_de_segmentos/09C-display/gruposdedigitos.cpp 

CPP_DEPS += \
./src/09-display_de_segmentos/09C-display/digito.d \
./src/09-display_de_segmentos/09C-display/display7Segmentos.d \
./src/09-display_de_segmentos/09C-display/gruposdedigitos.d 

OBJS += \
./src/09-display_de_segmentos/09C-display/digito.o \
./src/09-display_de_segmentos/09C-display/display7Segmentos.o \
./src/09-display_de_segmentos/09C-display/gruposdedigitos.o 


# Each subdirectory must supply rules for building sources it contributes
src/09-display_de_segmentos/09C-display/%.o: ../src/09-display_de_segmentos/09C-display/%.cpp src/09-display_de_segmentos/09C-display/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-09-2d-display_de_segmentos-2f-09C-2d-display

clean-src-2f-09-2d-display_de_segmentos-2f-09C-2d-display:
	-$(RM) ./src/09-display_de_segmentos/09C-display/digito.d ./src/09-display_de_segmentos/09C-display/digito.o ./src/09-display_de_segmentos/09C-display/display7Segmentos.d ./src/09-display_de_segmentos/09C-display/display7Segmentos.o ./src/09-display_de_segmentos/09C-display/gruposdedigitos.d ./src/09-display_de_segmentos/09C-display/gruposdedigitos.o

.PHONY: clean-src-2f-09-2d-display_de_segmentos-2f-09C-2d-display
