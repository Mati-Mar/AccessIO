...
CPP_SRCS += \
../src/06-timer/timer.cpp 

CPP_DEPS += \
./src/06-timer/timer.d 

OBJS += \
./src/06-timer/timer.o 


# Each subdirectory must supply rules for building sources it contributes
src/06-timer/%.o: ../src/06-timer/%.cpp src/06-timer/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-06-2d-timer

clean-src-2f-06-2d-timer:
	-$(RM) ./src/06-timer/timer.d ./src/06-timer/timer.o

.PHONY: clean-src-2f-06-2d-timer
